...
{
    Task<UserProfileResponse> RegisterUserAsync(UserRequest userRequest);
    ...
    // Admin role required
    Task<UserProfileResponse> GetSingleUserBySearchAsync(SingleUserSearchRequest searchRequest);

    // Admin role required
    Task<List<UserOverviewResponse>> GetUsersAsync(
        Guid? id,
        string? username,
        string? firstName,
        string? middleName,
